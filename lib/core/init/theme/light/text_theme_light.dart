...
class TextThemeLight {
  ...
  final TextStyle headline1 = const TextStyle(fontSize: 35, fontWeight: FontWeight.bold, letterSpacing: -1.5);
  final TextStyle headline2 = const TextStyle(fontSize: 30, fontWeight: FontWeight.w300, letterSpacing: -0.5);
  final TextStyle headline3 = const TextStyle(fontSize: 20, fontWeight: FontWeight.w400);
  ...
  final TextStyle bodyText1 = const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, letterSpacing: 0.5);
